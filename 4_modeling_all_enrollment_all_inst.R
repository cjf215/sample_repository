...
#total of 84,000 census tracts; should be 85000 in 2020
...
ggsave(here("figures","cross_val","rmse_logged_enrollment.jpg"))
...
stargazer(result_table,
          ...
          out = here("figures", "tables", "table1_all.html"))
...
stargazer(result_table,
          ...
          out = here("figures", "tables", "table2_instate.html"))
...
table3<-NULL
  ...
  stargazer(result_table,
            ...
            out = here("figures", "tables", "table3_instate_2yr.html"))
...
table4<-NULL
  ...
  stargazer(result_table,
            ...
            out = here("figures", "tables", "table4_instate_4yr.html"))
